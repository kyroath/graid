...
public class GroupCreatePageController implements Initializable {
    ...
    @FXML
    private JFXTextField noOfParticipantsField;
    @FXML
    private JFXTextField searchTags;
    ...
    @FXML
    private void searchTags(ActionEvent event) {
    }
    ...
    private void createGroup(ActionEvent event) {
        ...
        //GROUP CREATE İŞLEMİ BURADA YAPILACAK
