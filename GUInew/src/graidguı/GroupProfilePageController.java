 ...
 * @author Ege
 */
public class GroupProfilePageController implements Initializable {
    ...
    @FXML
    private ImageView currentGroupImage;
    ...
    private void getGroupProfileChangePage(MouseEvent event) {
        try {
            Parent root;
            Stage stage = new Stage();
            root = FXMLLoader.load(getClass().getResource("GroupProfileChangePage.fxml"));
            stage.setScene(new Scene(root));
            stage.show();
    ...
    @FXML
    private void createPoll(MouseEvent event) {
    }

    @FXML
    private void getGroupSettingsPage(MouseEvent event) {
    }
