...
public class ProfilePageController implements Initializable {
    ...
    @FXML
    private Label profileDescription;
    @FXML
    private ImageView memberPicture1;
    @FXML
    private Label reviewerName1;
    @FXML
    private Label reviewerRole1;
    @FXML
    ...
    @FXML
    private Label reviewerName2;
    @FXML
    private Label reviewerRole2;
    @FXML
    ...
    @FXML
    private Label reviewerName3;
    @FXML
    private Label reviewerRole3;
    @FXML
    ...
    @FXML
    private void getProfileChangePage(MouseEvent event) {
        try {
            Parent root;
            Stage stage = new Stage();
            root = FXMLLoader.load(getClass().getResource("ProfileChangePage.fxml"));
            stage.setScene(new Scene(root));
            stage.show();
