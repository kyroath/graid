 ...
 * @author Ege
 */
public class GroupSearchPageController implements Initializable {
    ...
    @FXML
    private Button gsGroup1;
    @FXML
    private Label tagLabel1;
    @FXML
    private Label simLabel1;
    @FXML
    private Label tagLabel2;
    @FXML
    private Label simLabel2;
    @FXML
    private Label simLabel3;
    @FXML
    ...
    @FXML
    private void getGroupCreatePage(ActionEvent event) {
        try{
             Parent root;   
             Stage stage = new Stage();
             root = FXMLLoader.load(getClass().getResource("GroupCreatePage.fxml"));
             stage.setScene(new Scene(root));
             stage.show();
             ((Node)(event.getSource())).getScene().getWindow().hide();
